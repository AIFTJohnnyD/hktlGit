...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<TableListItem>[] = [
    ...
    {
      title: (<FormattedMessage id='pages.lender_form.br_no'/>),
      dataIndex: 'br_no',
      valueType: 'textarea',
    },
    {
      title: (<FormattedMessage id='pages.lender_form.phone'/>),
      dataIndex: 'phone',
      valueType: 'textarea',
    },
    {
      title: (<FormattedMessage id='pages.lender_form.email'/>),
      dataIndex: 'email',
      valueType: 'textarea',
    },    
    {
      title: (<FormattedMessage id='pages.lender_form.address'/>),
      dataIndex: 'address',
      valueType: 'textarea',
    },
    {
